        ...
        static void Main(string[] args)
        {
            ...
            if (args.ElementAtOrDefault(0) == "console")
            {
                ...
                if (args.ElementAtOrDefault(1) == "simulate")
                {
                    ...
                    Simulate(processor, current, "target 1");
                    Simulate(processor, current, "target 1");
                    Simulate(processor, current, "target 0");
                }
...
//                        Out.main.WriteLines("Invalid command");
            ...
            if (args.ElementAtOrDefault(0) == "discord")
            {
                new DiscordProgram().MainAsync(args).GetAwaiter().GetResult();
            }
        }
